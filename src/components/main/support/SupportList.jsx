    ...
    return (
        <ul class="support__list">
            <li class="support__item">
                <div class="support__item-col">
                    <h3 class="support__item-title">Название тикета</h3>
                    <p class="support__item-subtitle">Maecenas vestibulum libero turpis, eu efficitur eros vehicula a. Duis fermentum fermentum tortor semper vulputate. Sed arcu est, tincidunt vel mi</p>
                </div>
                <div class="support__item-col">
                    ...
                    <div class="support__item-date-t">
                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="support__item-date">
                        <p>
                            ...
                            <span class="date__month">02</span>.
                            <span class="date__year">11</span>
                        </p>
                    </div>
                </div>
            </li>
            ...
            <li class="support__item">
                ...
                <div class="support__item-col">
                    <div class="support__item-status support__item-status-done">
                ...
                <div class="support__item-col">
                    ...
                    <div class="support__item-date">
                        <p>
                            ...
                            <span class="date__month">01</span>.
                            <span class="date__year">11</span>
                        </p>
                    </div>
                </div>
                ...
                <div class="support__item-col">
                    ...
                    <div class="support__item-date">
                        <p>
                            ...
                            <span class="date__month">11</span>.
                            <span class="date__year">10</span>
                        </p>
                    </div>
                </div>
            </li>
