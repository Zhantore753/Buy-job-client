        ...
        <>
            ...
            {feedbacksCheck &&
                <div className="support__load-more">
                    <button onClick={() => dispatch(getFeedbacks(selectedUser.id, feedbacks.length))} className="support__head-btn">Загрузить еще</button>
                </div>
            }
        </>
    );
